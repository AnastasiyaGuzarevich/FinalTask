...
public class TabletPC extends Appliance {
	...
	public TabletPC(String applianceName, double price, int quantity, int batteryCapacity, int displayInches, int memoryRom, int flashMemoryCapacity, String color) {
