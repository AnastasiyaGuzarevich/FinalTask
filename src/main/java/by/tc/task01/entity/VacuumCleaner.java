...
public class VacuumCleaner extends Appliance {
	...
	public VacuumCleaner(String applianceName, double price, int quantity, int powerConsumption, String filterType, String bagType, String wandType, int motorSpeedRegulation, int cleaningWidth) {
